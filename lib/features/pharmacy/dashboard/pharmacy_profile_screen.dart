        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Column(children: [
              ...
              const Text('MedPlus Pharmacy #42', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
              const SizedBox(height: 4),
              const Text('DL-KA-2023-0042  •  GSTIN: 29AAACM1234F1ZX', style: TextStyle(fontSize: 12, color: Colors.white70)),
              const SizedBox(height: 16),
              Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                _heroStat('1,247', 'Orders'),
          ...
          _sectionCard([
            ...
            _divider(),
            _tile(Icons.email_outlined, 'Email', 'medplus42@uha.health', const Color(0xFF10B981)),
            _divider(),
            _tile(Icons.local_hospital_outlined, 'Affiliated Hospital', 'City General Hospital', const Color(0xFF8B5CF6)),
          ]),
          const SizedBox(height: 16),
